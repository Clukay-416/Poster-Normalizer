...
out=root/'dist/PosterNormalizer_V0.4.0-rc1_Windows_Offline.zip'
...
excluded={'__pycache__','.pytest_cache','.git','.venv','runtime','runtime-ai','offline-ai','data','models','dist','dist-full'}
paths=[]
